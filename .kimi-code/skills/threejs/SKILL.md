---
name: threejs
description: Three.js 3D graphics framework — scene setup, geometry, materials, textures, lighting, animation, shaders, post-processing, interaction, and asset loading. Use as the entry point for any Three.js-related task; delegate specifics to sub-skills.
has-sub-skill: true
---

# Three.js

This is the top-level skill for [Three.js](https://threejs.org/) work. It covers the full rendering pipeline and serves as the entry point for any 3D graphics task.

For specific topics, use the sub-skills under `threejs/`:
